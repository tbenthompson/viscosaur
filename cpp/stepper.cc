...
namespace viscosaur
{
                      ...
                      double inv_rho)
    {
        ...
        sources[1] = &soln.old_disp;
        
        // Make a little data container that we can pass to the derivative
        // evaluators.
        EvalData<dim> data;
        ...
        pd.vel_matrix_free.initialize_dof_vector(dsdt);
        dsdt = 0;
        ...
        MatrixFreeCalculation<dim> mfc(pd, pd.vel_matrix_free, 
                pd.vel_hanging_node_constraints, false);
        ...
        VelEvalDerivFactory<dim> disp_op_factory;
